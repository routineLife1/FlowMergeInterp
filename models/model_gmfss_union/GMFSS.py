...
class Model:
    ...
    def load_model(self, path, rank):
        ...
        self.flownet.load_state_dict(torch.load('{}/flownet.pkl'.format(path), weights_only=True))
        self.metricnet.load_state_dict(torch.load('{}/metric.pkl'.format(path), weights_only=True))
        self.feat_ext.load_state_dict(torch.load('{}/feat.pkl'.format(path), weights_only=True))
        self.fusionnet.load_state_dict(torch.load('{}/fusionnet.pkl'.format(path), weights_only=True))
